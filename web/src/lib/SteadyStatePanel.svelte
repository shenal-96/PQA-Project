<script lang="ts">
  ...
  import type { Caps, SteadyWindow, SteadyWindowEdit } from '../backend/types';
  import { cell, num2 } from './format';

  let { windows, backend, caps }: {
  ...
  // the table without round-tripping through the parent). Seeded from the prop;
